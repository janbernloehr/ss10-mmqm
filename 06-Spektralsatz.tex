...
\text{Subadditivität}.
\end{align*}
% Für jedes $\ph\in\Hc$ ist die Abbildung
% \begin{align*}
% \mu: \Bc\to\R,\quad \Omega\mapsto \lin{\ph,P_\Omega \ph}
% \end{align*}
% ein Borel-Maß.
...
\emph{Spektralmaß}.\index{Spektralmaß}\fish
\end{defn*}
\begin{proof}
Siehe \cite{Tes09}.\qed
% Habe $P:\Bc\to\Lc(\Hc)$ die Eigenschaften \ref{prop:6.4:1}-\ref{prop:6.4:3}.
% Dann gilt für jedes $A\in\Bc$,
% \begin{align*}
...
% \end{align*}
% 
% Wir zeigen, dass für jedes $\ph\in\Hc$ die Abbildung $\mu$ ein Borel-Maß ist.
% Monotonie und Subadditivität von $P$ folgen dann sofort.
% 
% Für jedes $\Omega\in\Bc$ ist 
% \begin{align*}
...
% bemerken wir dass für $A,B\in \Bc$ disjunkt gilt $A\subset\R\setminus B$,
% \begin{align*}
% 0\le P_AP_B \le P_{\R\setminus B}P_B = 0,
% \end{align*}
% und folglich $P_AP_B = 0$. Seien 
% $\Omega,\Omega'\in \Bc$ und
% weiterhin
% \begin{align*} 
% &(\Omega\cap \Omega')\dcup A = \Omega,\qquad
% (\Omega\cap \Omega')\dcup B = \Omega',
% \end{align*}
% mit $A,B\in\Bc$. Dann sind $A$, $B$ und $\Omega\cap \Omega'$ disjunkt und
% \begin{align*}
% P_\Omega P_{\Omega'}
